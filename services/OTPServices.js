...
async function getAndSendOTP(keyObject, phone){
    ...
    if(user_type== 'RECRUITER'){
        content = encodeURIComponent (`Dear Recruiter\n Thank You for applying to Delhi Government RojgarBazaar. Your OTP for the registration is ${otp}. \n\n We wish you the Best of Luck.`)
    } else if(user_type== 'JOBSEEKER'){
        content = encodeURIComponent (`Dear JobSeeker \n Thank You for applying to Delhi Government RojgarBazaar. Your OTP for the registration is ${otp}. \n\n We wish you the Best of Luck.`)
    }
